...
def build_default_prompt_family_catalog() -> PromptFamilyCatalog:
    ...
    families = [
        ...
        PromptFamilySpec(
            ...
            required_parameters=("target",),
            primary_result_shapes=("table",),
            allowed_plan_actions=("filter_frame", "rank_frame"),
        ...
        PromptFamilySpec(
            ...
            primary_result_shapes=("table",),
            allowed_plan_actions=("time_bucket_frame", "period_comparison", "grouped_period_comparison"),
        ),
        PromptFamilySpec(
        ...
        PromptFamilySpec(
            ...
            allowed_plan_actions=("filter_frame", "aggregate_value", "row_count"),
            governance="partial",
