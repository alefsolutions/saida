...
def build_default_analytics_registry() -> AnalyticsRegistry:
    ...
    _register_methods(
        ...
        "selection_filtering",
        (
            ("filter_frame", "Filter Frame", "Return a filtered frame artifact for downstream DAG transforms.", ("dataset",), ("filters", "table_name"), ("table",), "duckdb"),
            ("select_columns", "Select Columns", "Project a frame down to explicit columns.", ("dataset", "selected_columns"), ("filters", "table_name"), ("table",), "duckdb"),
            ("sort_frame", "Sort Frame", "Sort a frame by one column with a deterministic order.", ("dataset", "sort_by"), ("filters", "sort_direction", "table_name"), ("table",), "duckdb"),
            ("limit_frame", "Limit Frame", "Limit a frame to the first N rows after optional sorting.", ("dataset", "limit"), ("filters", "sort_by", "sort_direction", "table_name"), ("table",), "duckdb"),
            ("distinct_frame", "Distinct Frame", "Return the distinct row combinations for explicit columns.", ("dataset", "selected_columns"), ("filters", "table_name"), ("table",), "duckdb"),
        ),
    )
    _register_methods(
        registry,
        "transformation",
        (
            ("derive_column", "Derive Column", "Create one derived column from an explicit expression contract.", ("dataset", "target", "expression"), ("filters", "table_name"), ("table",), "duckdb"),
    ...
    _register_methods(
        ...
        "ranking",
        (
            ("rank_frame", "Rank Frame", "Rank rows within a frame by a sort key.", ("dataset", "sort_by"), ("filters", "sort_direction", "limit", "rank_column", "table_name"), ("table",), "duckdb"),
