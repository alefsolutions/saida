...
LLM_INTENT_PROMPT_CONTRACT = {
    ...
    "routing_rules": [
        ...
        "If possible, return operation and object_kind to describe what the user is trying to do, such as count+rows, list+rows, count+columns, count+distinct_values, or sum+measure.",
        "Use object_ref for a concrete column-like object when needed, such as team for distinct_value_count(team).",
        "Use expected_result_shape when you can tell whether the user wants a scalar count, an aggregate, a table, a recordset, or a verification result.",
